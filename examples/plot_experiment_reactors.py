...
sns.lineplot(x='average_temperature', y='average_transmission', 
    hue='reactor', data=analyzer.df, ax=ax) 
...
sns.lineplot(x='average_temperature', y='average_transmission', 
    hue='reactor', data=analyzer.df, ax=axes[0]) 
axes[0].set_xlabel('Temperature (C)')
axes[0].set_ylabel('Average Transmission (%)')

sns.lineplot(x='average_temperature', y='median_transmission', 
    hue='reactor', data=analyzer.df, ax=axes[1]) 
...
sns.lineplot(x='average_temperature', y='average_transmission', 
    hue='reactor', data=analyzer.df, ax=axes[0][0]) 
axes[0][0].set_xlabel('Temperature (C)')
axes[0][0].set_ylabel('Average Transmission (%)')

sns.lineplot(x='average_temperature', y='median_transmission', 
    hue='reactor', data=analyzer.df, ax=axes[0][1]) 
axes[0][1].set_xlabel('Temperature (C)')
axes[0][1].set_ylabel('Median Transmission (%)')

sns.lineplot(x='temperature', y='transmission', errorbar='sd',
    hue='reactor', data=analyzer.unprocessed_df, ax=axes[1][0]) 
...
experiment2 = Experiment.load_from_file(str(Path('data') / 'MA-PEG-TOL -5-15-30-50 mgpmL.csv'))
